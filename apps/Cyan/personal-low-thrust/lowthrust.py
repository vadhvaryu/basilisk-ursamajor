"""
lowthrust_basilisk_full.py

Continuous low-thrust transfer from LEO to GEO using 1 thruster opposite velocity,
followed by a coast phase (2 weeks) to check orbit stability.

+ Graph plotted at end
"""
import numpy as np
import matplotlib.pyplot as plt
from Basilisk.utilities import SimulationBaseClass, macros
from Basilisk.simulation import spacecraft, simIncludeGravBody
...
def run_lowthrust_basilisk():
    ...
    ax.annotate("Thrust End / Coast Start", xy=(r_vec_thrust[-1,0], r_vec_thrust[-1,1]),
                xytext=(r_vec_thrust[-1,0]*1.05, r_vec_thrust[-1,1]*1.05),
